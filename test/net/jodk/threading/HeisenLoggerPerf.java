...
public class HeisenLoggerPerf {
    ...
    private static final boolean DO_LOG_DATE = false;
        ...
        public void run() {
            ...
            for (int i=0;i<nbrOfLogs;i++) {
                synchronized (sb) {
                    ...
                    if (DO_LOG_DATE) {
                        sb.append(" ");
                        sb.append(System.nanoTime() - INITIAL_DATE_NS);
                    }
                    if (DO_LOG_THREAD) {
                        sb.append(" ");
    ...
    private void run(String[] args) {
        ...
        HeisenLogger.setDoLogDate(DO_LOG_DATE);
        HeisenLogger.setDoLogThread(DO_LOG_THREAD);
